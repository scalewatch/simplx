...
#define SIMPLX_CACHE_LINE_SIZE 64
static const int CACHE_LINE_SIZE = SIMPLX_CACHE_LINE_SIZE; // architecture dependent
#define SIMPLX_CACHE_LINE_PADDING(x)                                                                                 \
    (::simplx::CACHE_LINE_SIZE * ((x + ::simplx::CACHE_LINE_SIZE - 1) / ::simplx::CACHE_LINE_SIZE) - (x))
