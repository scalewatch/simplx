...
#define SIMPLX_DEFAULT_STREAM_BUFFER_INCREMENT_SIZE 512 /**< Default stream buffer increment size */

/**
 * @brief StreamBuffer class
 */
template <typename _Char, class _Allocator, size_t _BufferSizeIncrement = SIMPLX_DEFAULT_STREAM_BUFFER_INCREMENT_SIZE>
