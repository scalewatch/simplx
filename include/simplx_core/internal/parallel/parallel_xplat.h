...
#include "simplx_core/internal/parallel/parallel_pthread.h"          // should be CONDITIONAL on PARALLEL_CXX11 or PARALLEL_PTHREAD
...
protected:
    ...
    friend class Signal;
    friend class ::simplx::Lock<Mutex>;           // why needs namespace qualifier?
