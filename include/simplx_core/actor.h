...
#include "simplx_core/internal/refmapper.h"
#include "pattern/enterprise.h"
...
struct FeatureNotImplementedException : std::exception
{
    ...
    {   // feature is not (yet) implemented!
        return "simplx::FeaturedNotImplementedException";
    }
};
 ...
 */
inline void breakThrow(const std::exception &e) noexcept(false)
{
...
class Actor : private MultiDoubleChainLink<Actor, 2u>, virtual private ActorBase
{
  public:
    ...
    {
        virtual const char *what() const noexcept { return "simplx::Actor::CircularReferenceException"; }
    };
...
public:
    ...
    struct AlreadyRegisterdEventHandlerException : std::exception
    {
        ...
        {
            return "simplx::Actor::AlreadyRegisterdEventHandlerException";
        }
    };
    ...
    struct ShutdownException : std::exception
    {
        ...
        virtual const char *what() const noexcept
        {
            ...
            {
                return "simplx::Actor::ShutdownException (the engine is terminating)";
            }
            else
            {
                return "simplx::Actor::ShutdownException (the core is terminating)";
            }
        }
    };
    ...
    struct ReferenceLocalActorException : std::exception
    {
        ...
        virtual const char *what() const noexcept
        {
            if (notLocalFlag)
            {
                return "simplx::Actor::ReferenceLocalActorException (the actor belongs to a different core)";
            }
            else
            {
                return "simplx::Actor::ReferenceLocalActorException (the actor doesn't exist anymore)";
            }
        }
    };
 ...
 */
    ...
    class Callback : private MultiDoubleChainLink<Callback>
    {
      ...
      private:
        ...
        {
            inline static Callback *getItem(::simplx::MultiDoubleChainLink<Callback> *link) noexcept
            {
                return static_cast<Callback *>(link);
            }
            inline static const Callback *getItem(const ::simplx::MultiDoubleChainLink<Callback> *link) noexcept
            {
                return static_cast<const Callback *>(link);
            }
            inline static ::simplx::MultiDoubleChainLink<Callback> *getLink(Callback *item) noexcept
            {
                return static_cast<::simplx::MultiDoubleChainLink<Callback> *>(item);
            }
            inline static const ::simplx::MultiDoubleChainLink<Callback> *getLink(const Callback *item) noexcept
            {
                return static_cast<const ::simplx::MultiDoubleChainLink<Callback> *>(item);
            }
        };
        Chain *chain;
    ...
    typedef Property<Allocator<char>> property_type; ///< simplx::Property specialization using Actor::Allocator.
    typedef OutputStringStream<char, Allocator<char>,
                               SIMPLX_DEFAULT_STREAM_BUFFER_INCREMENT_SIZE>
        ostringstream_type; ///< simplx::OutputStringStream specialization using Actor::Allocator.
...
#pragma pack(1)
    ...
    class InProcessActorId
    {
      ...
      public:
         ...
         * @param simplx::null represents the invalid value of actor-id.
         * @return A reference to this instance.
         */
    ...
    class ActorId : public InProcessActorId
    {
      public:
        ...
        {
            virtual const char *what() const noexcept { return "simplx::Actor::ActorId::NotInProcessException"; }
        };
        /**
        ...
        class RouteIdComparable
        {
          public:
             ...
             * @param simplx::null represents the invalid value of route-id.
             * @return A reference to this instance.
             */
...
#pragma pack(pop)
  ...
  protected:
     ...
     * <br>Example:
     * \code
     * class MyActor : public simplx::Actor {
     * protected:
...
{
    virtual const char *what() const noexcept { return "simplx::Actor::ReturnToSenderException"; }
};
...
struct Actor::UndersizedException : std::bad_alloc
{
    ...
    virtual const char *what() const noexcept
    {
        ...
        {
        case EVENT_ID:
            return "simplx::Actor::UndersizedException(EVENT_ID)";
        case SINGLETON_ACTOR_INDEX:
            return "simplx::Actor::UndersizedException(SINGLETON_ACTOR_INDEX)";
        }
        return "simplx::Actor::UndersizedException";
    }
};
 ...
 * - simplx::EngineToEngineConnectorEventFactory::newEvent()
 *
...
public:
    ...
    struct DuplicateAbsoluteEventIdException : std::exception
    {
        const char *what() const noexcept override
        {
            return "simplx::Actor::Event::DuplicateAbsoluteEventIdException";
        }
    };
     ...
     * <br>Example:
     * \code
     * class MyEvent : public simplx::Actor::Event {
     * public:
     *     static void nameToOStream(std::ostream& s, const Event& event) {
 ...
 * Example:
 * \code
 * class MyActor : public simplx::Actor, public simplx::Actor::Callback {
 * public:
 *     struct MyEvent : simplx::Actor::Event {
 *         unsigned count;
 *         MyEvent() :
 *             count(0) {
 *         }
...
class Actor::Event::Batch
{
  public:
     ...
     * };
     *
     * MyEvent& firstCycleIteration(simplx::Actor::Event::Pipe& pipe, simplx::Actor::Event::Batch& batch) {
     *     batch = simplx::Actor::Event::Batch(pipe); // this call initializes batch with respect to a push occurring in
     ...
     * }
     *
     * MyEvent& nextCycleIteration(MyEvent& myCurrentEvent, simplx::Actor::Event::Pipe& pipe, simplx::Actor::Event::Batch&
     * batch) {
 ...
 * };
 *
 * void atomicPush(simplx::Actor& source, const simplx::Actor::ActorId& firstDestination, const simplx::Actor::ActorId&
 * secondDestination) {
...
class Actor::Event::BufferedPipe : public Actor::Event::Pipe
{
  public:
    ...
    struct MixedBatchBufferedEventsException : std::exception
    {
        virtual const char *what() const noexcept
        {
            return "simplx::Actor::Event::BufferedPipe::MixedBatchBufferedEventsException";
        }
    };
...
namespace std
{
template <> struct hash<simplx::Actor::ActorId>
{
    std::size_t operator()(const simplx::Actor::ActorId &actorId) const noexcept
    {
