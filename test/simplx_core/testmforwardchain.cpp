...
struct TestItemWithOneLink : private simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT>
{
    ...
    TestItemWithOneLink(const TestItemWithOneLink &)
        : simplx::MultiForwardChainLink<TestItemWithOneLink, _CHAIN_COUNT>(), v((uintptr_t) this)
    {
    }
};
...
template <unsigned _CHAIN_COUNT> class TestChainWithOneLink
{
  public:
    ...
    struct ForwardChain
        : simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>,
                                          _CHAIN_COUNT>::template ForwardChain<_CHAIN_ID, ForwardChain<_CHAIN_ID>>
    {
        inline static TestItemWithOneLink<_CHAIN_COUNT> *getItem(
            typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT> *link) noexcept
        {
            return static_cast<TestItemWithOneLink<_CHAIN_COUNT> *>(link);
        }
        inline static const TestItemWithOneLink<_CHAIN_COUNT> *
        getItem(const typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT>
                    *link) noexcept
        {
            return static_cast<const TestItemWithOneLink<_CHAIN_COUNT> *>(link);
        }
        inline static typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT> *
        getLink(TestItemWithOneLink<_CHAIN_COUNT> *item) noexcept
        {
            return static_cast<
                typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT> *>(item);
        }
        inline static const typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT> *
        getLink(const TestItemWithOneLink<_CHAIN_COUNT> *item) noexcept
        {
            return static_cast<
                const typename simplx::MultiForwardChainLink<TestItemWithOneLink<_CHAIN_COUNT>, _CHAIN_COUNT> *>(
                item);
        }
    };
